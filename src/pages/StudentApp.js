...
const StudentApp = () => {
  return (
    <>
    <h2>Student App</h2>
    {/* <a href='https://uncharted-app.onrender.com/' target="_blank" rel="noreferrer" title='Uncharted' style={{marginLeft:"48%"}}><h5 >Live Link</h5></a> */}
    {/* <h4>What is it?</h4> */}
    <h4>Please excuse the mess...under construction...</h4>
    <img src='/download.jpeg' alt='coming soon sign' style={{marginLeft: "40%", marginRight: "auto"}}/>
    {/* <div className='info'>
